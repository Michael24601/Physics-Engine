...
#ifndef RIGID_BODY_BUNGEE_FORCE_H
#define RIGID_BODY_BUNGEE_FORCE_H
...
namespace pe {
	...
	class RigidBodyBungeeForce : public RigidBodyForceGenerator {
	...
	public:
		...
		RigidBodyBungeeForce(const Vector3D& connectionPoint,
